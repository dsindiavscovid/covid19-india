    ...
    def __init__(self, model_parameters: dict):
        ...
        if("latent_information" in self.model_parameters.keys()):
            if("latent_variables" in self.model_parameters["latent_information"].keys()):
                self.model_parameters["latent_information"]["latent_variables"] = [ForecastVariable(fv) for fv in self.model_parameters["latent_information"]["latent_variables"]]
                
            if("latent_on" in self.model_parameters["latent_information"].keys()):
                self.model_parameters["latent_information"]["latent_on"] = ForecastVariable(self.model_parameters["latent_information"]["latent_on"])
    ...
    def _convertLatentStrToForecastEntity(self, model_parameters):
        if("latent_information" in model_parameters.keys()):
            if("latent_variables" in model_parameters["latent_information"].keys()):
                model_parameters["latent_information"]["latent_variables"] = [ForecastVariable(fv) for fv in model_parameters["latent_information"]["latent_variables"]]
                
            if("latent_on" in model_parameters["latent_information"].keys()):
                model_parameters["latent_information"]["latent_on"] = ForecastVariable(model_parameters["latent_information"]["latent_on"])
