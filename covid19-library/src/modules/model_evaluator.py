...
class ModelEvaluator(object):
    ...
    def evaluate(self, region_metadata, observations, run_day, test_start_date, test_end_date, loss_functions, latent_information):
        predictions = self._model.predict(region_metadata, observations, run_day, test_start_date, test_end_date, latent_information['latent_variables'], latent_information['latent_on'])
        return self.evaluate_for_forecast(observations, predictions, loss_functions)

    def evaluate_for_region(self, data_source, region_type, region_name, run_day, test_start_date, test_end_date, loss_functions, latent_information):
        ...
        return self.evaluate(region_metadata, observations, run_day, test_start_date, test_end_date, loss_functions, latent_information)
